...
export default function UserDashboard() {
  ...
  const groupedByCategory = filteredBooks.reduce((acc, book) => {
    const kategori = book.kategori || "Lainnya"; // Menentukan kategori (default: "Lainnya")
  ...
  // Intersection Observer untuk animasi masuk kategori
  useEffect(() => {
    ...
    // Observasi setiap kategori buku
      ...
      <div className="user-dashboard-container">
        <div className="user-dashboard-header">
          ...
          <div className="search-bar-container">
            <SearchBar
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)} // Menyaring buku sesuai dengan kata kunci pencarian
            />
          </div>
        </div>
